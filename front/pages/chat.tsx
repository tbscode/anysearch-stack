  ...
  return (
    <main className="flex bg-background max-h-screen overflow-hidden">
      ...
      <section className="flex content-center align-middle flex-col justify-center min-w-fit px-12">
        ...
        <img className="w-24 rounded-full" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Frevgineer.com%2Fwp-content%2Fuploads%2F2019%2F12%2FThisPersonDoesNotExist_fail2-768x811.jpg&f=1&nofb=1&ipt=b88a3d792b206b14cb27c58ef847d473ce09ec6a69ffc6b6db5c280bf0ea12dd&ipo=images" />
        ...
        <div className="flex flex-col gap-2">
          ...
          <button className="btn gap-2">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M22 15.2998C21.4 15.2998 21 15.6998 21 16.2998V18.9998C21 20.0998 20.1 21.0998 18.9 21.0998H16.2C15.6 21.0998 15.2 21.4998 15.2 22.0998C15.2 22.6998 15.6 23.0998 16.2 23.0998H18.9C21.1 23.0998 23 21.2998 23 18.9998V16.2998C23 15.6998 22.6 15.2998 22 15.2998Z" fill="#D3D3D3" />
              <path d="M7.8 21.0002H5.1C3.9 21.0002 3 20.1002 3 18.9002V16.2002C3 15.6002 2.6 15.2002 2 15.2002C1.4 15.2002 1 15.6002 1 16.2002V18.9002C1 21.2002 2.8 23.0002 5.1 23.0002H7.8C8.4 23.0002 8.8 22.6002 8.8 22.0002C8.8 21.4002 8.3 21.0002 7.8 21.0002Z" fill="#D3D3D3" />
              <path d="M2 8.8C2.6 8.8 3 8.4 3 7.8V5.1C3 3.9 3.9 3 5.1 3H7.8C8.4 3 8.8 2.6 8.8 2C8.8 1.4 8.4 1 7.8 1H5.1C2.8 1 1 2.8 1 5.1V7.8C1 8.3 1.4 8.8 2 8.8Z" fill="#D3D3D3" />
              <path d="M18.9 1H16.2C15.6 1 15.2 1.4 15.2 2C15.2 2.6 15.6 3 16.2 3H18.9C20.1 3 21 3.9 21 5.1V7.8C21 8.4 21.4 8.8 22 8.8C22.6 8.8 23 8.4 23 7.8V5.1C23 2.8 21.2 1 18.9 1Z" fill="#D3D3D3" />
              <path d="M18.2 9.9C18.8 9.9 19.2 9.5 19.2 8.9V7.3C19.2 6.3 18.4 5.5 17.4 5.5H6.59999C5.59999 5.5 4.79999 6.3 4.79999 7.3V9C4.79999 9.6 5.19999 10 5.79999 10C6.39999 10 6.79999 9.6 6.79999 9V7.5H9.09999V17.2H7.99999C7.39999 17.2 6.99999 17.6 6.99999 18.2C6.99999 18.8 7.39999 19.2 7.99999 19.2H16C16.6 19.2 17 18.8 17 18.2C17 17.6 16.6 17.2 16 17.2H14.8V7.5H17.1V8.9C17.2 9.5 17.6 9.9 18.2 9.9ZM12.8 17.2H11.1V7.5H12.8V17.2Z" fill="#D3D3D3" />
            </svg>
            Change Lenguage
          </button>
          <button className="btn gap-2">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 19C11.1969 19 10.4941 18.6946 9.99216 18.0838L4.47059 11.3653C3.96863 10.7545 3.86824 9.83832 4.16941 9.12575C4.47059 8.41317 5.17333 7.90419 5.97647 7.90419H8.28549V4.34132C8.28549 3.01796 9.3898 2 10.6949 2H13.4055C14.7106 2 15.7145 3.01796 15.7145 4.34132V7.90419H18.0235C18.8267 7.90419 19.5294 8.31138 19.8306 9.12575C20.1318 9.83832 20.0314 10.6527 19.5294 11.2635L14.0078 18.0838C13.5059 18.6946 12.8031 19 12 19ZM5.97647 10.0419L11.498 16.7605C11.6988 16.9641 11.8996 16.9641 12 16.9641C12.1004 16.9641 12.3012 16.9641 12.502 16.7605L18.0235 10.0419H14.7106C14.1082 10.0419 13.7067 9.63473 13.7067 9.02395V4.34132C13.7067 4.13772 13.5059 4.03593 13.4055 4.03593H10.6949C10.4941 4.03593 10.2933 4.23952 10.2933 4.34132V8.92216C10.2933 9.53293 9.89177 9.94012 9.28941 9.94012H5.97647V10.0419Z" fill="#D3D3D3" />
              <path d="M18.4179 22H5.48259C3.49254 22 2 20.5 2 18.5V16C2 15.4 2.39801 15 2.99502 15C3.59204 15 3.99005 15.4 3.99005 16V18.5C3.99005 19.3 4.68657 20 5.48259 20H18.5174C19.3134 20 20.01 19.3 20.01 18.5V16C20.01 15.4 20.408 15 21.005 15C21.602 15 22 15.4 22 16V18.5C21.9005 20.5 20.408 22 18.4179 22Z" fill="#D3D3D3" />
            </svg>
            Get Report
          </button>
        </div>
